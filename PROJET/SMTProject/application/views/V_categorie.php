                ...
                <div class="wrap-contact3">
                    ...
                    <div class="contact3-form validate-form">
                        ...
                        <div class="row">
                                ...
                                <a href="<?php echo site_url("C_enseigne"); ?>" id="shoplogo"><img src="<?php echo base_url("assets/"); ?>images/shop.png"/></a>

                                <h2 class="title" id="titreCat">Catégorie</h2>
                        ...
                        foreach ($categories as $categorie) {
                            ...
                            <div class="row">
                                ...
                                <div id="ajust" class="col">
                                    ...
                                    <h4 class="font"><?php echo $categorie["nom"];?></h4>
                                </div>
